...
// await CreateSolverStructureAsync("/Users/dnemec/workspace/advent-of-code/AdventOfCode2025");
// return;
...
async Task<string> GetOrDownloadInputAsync()
{
    ...
    if (!File.Exists(path))
    {
        ...
        var session = config["aocSession"] ?? throw new ArgumentException("Key 'aocSession' is missing in User Secrets.");
